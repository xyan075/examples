...
PROGRAM CANTILEVEREXAMPLE
  ...
  CALL CMISSSolver_NewtonConvergenceTestTypeSet(Solver,CMISS_SOLVER_NEWTON_CONVERGENCE_ENERGY_NORM,Err)
  !CALL CMISSSolver_NewtonConvergenceTestTypeSet(Solver,CMISS_SOLVER_NEWTON_CONVERGENCE_PETSC_DEFAULT,Err)
  !CALL CMISSSolver_NewtonConvergenceTestTypeSet(Solver,CMISS_SOLVER_NEWTON_CONVERGENCE_DIFFERENTIATED_RATIO,Err)
